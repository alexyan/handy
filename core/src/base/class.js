define(function(require, exports, module) {
  ...
  Class.create = function(parent, properties) {
    ...
    function SubClass() {
      ...
      //set $parent and  $root at every object node.
      args.length > 0 && (function(){
      	args[args.length - 1]['$root'] && (function(){
      		that.__proto__.$root = args[args.length - 1]['$root'];
      	})();
      	args[args.length - 1]['$parent'] && (function(){
      		that.__proto__.$parent = args[args.length - 1]['$parent'];
      	})();
      ...
      parent.apply(that, arguments)

      // Only call initialize in self constructor.
      if (that.constructor === SubClass && that.initialize) {
